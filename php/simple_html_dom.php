...
class simple_html_dom_node
{
	...
	function clear()
	{
		// Para arreglar error de memoria:
			// http://stackoverflow.com/questions/3830187/zend-mm-heap-error-with-simple-html-dom
			// http://sourceforge.net/p/simplehtmldom/patches/3/
		//$this->dom = null;
		//$this->nodes = null;
		//$this->parent = null;
		//$this->children = null;
